using static PuntoVentaAPI.Models.ComunesModel;
...
namespace PuntoVentaAPI.Models
{
		...
		public class ComunesModel(IConfiguration iConfiguration) : IComunesModel
		{
			...
			{
				string cuenta = iConfiguration.GetSection("settings:CorreoEmail").Value!;
				string contrasenna = iConfiguration.GetSection("settings:ClaveEmail").Value!;
